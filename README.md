...
| `0005-advanced-preferences-pane.patch` | An **Advanced** preferences pane surfacing the options above — background level slider, tooltip timing, WYSIWYG dark background wells with Stock buttons, sequential page numbering. | The pane itself is Skim+'s own idea |
